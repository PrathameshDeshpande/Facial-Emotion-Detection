...
decoder_output = Conv2D(128, (3,3), activation='relu', padding='same')(decoder_output1)
...
decoder_output = UpSampling2D((2, 2))(decoder_output)
model = Model(inputs=encoder_input1, outputs=decoder_output)
model.summary()
# compiling the model
...
# Fitting the model
model.fit(vgg_features, Y, validation_split = 0.2,verbose=1, epochs=2500, batch_size=128,callbacks=callbacks_list)
