from imports import *
from model import create_model1,create_model2,create_features_vgg,create_features_resnet,create_features_xception,create_model3
...
decoder_output = Conv2D(512, (3,3), activation='relu', padding='same')(decoder_output)
...
# Fitting the model
model.fit((vgg_features,resnet_features,exception_feature), Y, validation_split = 0.2,verbose=1, epochs=1000, batch_size=128,callbacks=callbacks_list)
